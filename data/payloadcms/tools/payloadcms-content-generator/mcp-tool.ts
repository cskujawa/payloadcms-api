...
export class PayloadCMSContentGeneratorTool {
  private client: PayloadCMSClient;
   ...
   */
  async createPostFromJSON(request: PostCreationRequest): Promise<ContentGeneratorResult> {
    try {
      // Validate JSON input
   ...
   */
  private async enhancePostDataFromJSON(postData: PostData, request: PostCreationRequest): Promise<PostData> {
   ...
   */
  private async processMediaBlocks(postData: PostData): Promise<void> {
    const processBlocks = (blocks: any[]): Promise<void>[] => {
   ...
   */
  async test(): Promise<ContentGeneratorResult> {
    const testRequest: PostCreationRequest = {
 ...
 */
export async function payloadcms_create_post_from_json(request: PostCreationRequest): Promise<ContentGeneratorResult> {
 ...
 */
export async function payloadcms_get_status(): Promise<any> {
  const tool = new PayloadCMSContentGeneratorTool();
 ...
 * Test the tool functionality
 */
export async function payloadcms_test_tool(): Promise<ContentGeneratorResult> {
  const tool = new PayloadCMSContentGeneratorTool();
